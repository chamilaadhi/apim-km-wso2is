...
import wso2is.key.manager.operations.endpoint.util.UserInfoUtil;
...
public class ClaimsApiServiceImpl implements ClaimsApiService {
    ...
    public Response claimsGeneratePost(ClaimRequestDTO properties, MessageContext messageContext) {
        ...
        if (properties != null) {
            ...
            if(properties.isConvertDialect() != null && properties.isConvertDialect()) {
                convertDialect = true;
            }
        }
        properties.isConvertDialect();
